...
It is often our goal to measure, analyze, and communicate properties of physical systems such that the behavour of similar systems may be predicted. Measuring properties of a physical system is very difficult. Enormous time and cost is used to develop environments and tools to increase the accuracy of these systems. When we do not have these resources, approximations can be used to smooth the noise generated by our instrumentation and environment.

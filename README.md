...
Additionally, an observed maximum intensity implies that the sensor has been saturated. We are unable to differentiate light whose intensity registers `maximum` vs `maximum+50`.
